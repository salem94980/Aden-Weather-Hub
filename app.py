...
def load_data():
    try:
        ...
        # تحويل التاريخ والوقت بناءً على الأعمدة التي زودتني بها
...
def render_page(pathname):
    if pathname == "/dashboard":
        if df_main.empty:
            return html.Div([html.H3("⚠️ البيانات غير متوفرة. تأكد من رفع ملف الإكسل.", style={"color":"orange", "padding":"50px"})]), []
    ...
    return html.Div(style={
        "height": "100vh", "backgroundColor": "#0a0c10", "display": "flex", "flexDirection": "column", "justifyContent": "center", "alignItems": "center", "textAlign": "center"
    }, children=[
...
def update_dash(start, end, hours):
    ...
    stats = dbc.Row([
        dbc.Col(dbc.Card([dbc.CardBody([html.H6("AVG TEMPERATURE"), html.H3(f"{dff['Temp C'].mean():.1f}°C", style={"color": "#ff5f5f"})])], style={"backgroundColor": "#161b22"})),
    ...
    f_d = px.line(dff, x="Full_Timestamp", y="DewPt C", template="plotly_dark", height=500).update_traces(line_color="#00f2ff", line_width=4)
