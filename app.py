...
def load_data():
    try:
        # تأكد أن اسم الملف في GitHub هو Aden_METAR_Final_Report.xlsx
...
def render_page(pathname):
    ...
    # مسار HOME (الواجهة الرئيسية)
    return html.Div(style={
        "height": "100vh",
        "backgroundColor": "#0a0c10", # خلفية داكنة ثابتة
...
def update_dash(start, end, hours):
    ...
    table = dash_table.DataTable(
        ...
        style_cell={"backgroundColor": "#0d1117", "color": "#c9d1d9", "textAlign": "left", "fontFamily": "monospace", "padding": "10px"},
