...
app.layout = html.Div([
    ...
    # Sidebar ثابت لضمان عمل الفلتر 100%
    html.Div(id="sidebar-id", style={
        ...
        html.Div(id="filter-wrapper", children=[
            ...
            dcc.Dropdown(id="h-drop", options=[{"label": f"{h:02d}:00", "value": h} for h in range(24)], multi=True, style={"color": "black"}, persistence=True)
        ])
    ]),
...
def render_page(pathname):
    ...
    if pathname == "/dashboard":
        layout = html.Div(style={"padding": "2.5rem", "backgroundColor": "#0d1117"}, children=[
            ...
            # استعادة كافة الرسوم البيانية بالعناوين الأصلية
        ...
        return layout, {"display": "block", "position": "fixed", "width": "18rem", "height": "100vh", "backgroundColor": "#0a0c10", "padding": "2rem 1rem", "borderRight": "1px solid #1a1e26", "zIndex": 100}, {"display": "block"}

    # Landing Page - تصميمك السينمائي
    home_layout = html.Div(style={
        ...
        html.A(html.Button("INITIATE ANALYTICS", style={"backgroundColor": "transparent", "color": "#00f2ff", "border": "2px solid #00f2ff", "padding": "15px 45px", "fontFamily": "Orbitron", "cursor": "pointer"}), href="/dashboard")
    ])
